					...
					<div className="inner-wrap">
						...
						<div className="nav">
							...
							<div className="nav-links">
								<Link to="#0" target="_blank">Home</Link>
								<Link to="#0" target="_blank">Shop</Link>
								<Link to="#0" target="_blank">About</Link>
								<Link to="#0" target="_blank">FAQ's</Link>
								<Link to="#0" target="_blank">Contact</Link>
							</div>
						</div>
